                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground">Price: ₹{product.prices.zepto}</p>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Subtotal:</span>
                      <span className="font-bold text-xl">₹{cartItems.reduce((sum, item) => sum + (item.product.prices.zepto * item.quantity), 0)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Delivery:</span>
