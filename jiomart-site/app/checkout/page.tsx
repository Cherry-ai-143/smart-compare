      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground">Price: ₹{product.prices.jiomart}</p>
          ...
          <div className="space-y-6">
            <Card className="glassmorphism ring-2 ring-blue-500 animate-glow">
              <CardHeader>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Subtotal:</span>
                      <span className="font-bold text-xl">₹{cartItems.reduce((sum, item) => sum + (item.product.prices.jiomart * item.quantity), 0)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Delivery:</span>
                  ...
                  <Button
                    className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover-glow"
