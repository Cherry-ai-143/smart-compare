                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground">Price: ₹{product.prices.bigbasket}</p>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Subtotal:</span>
                      <span className="font-bold text-xl">₹{cartItems.reduce((sum, item) => sum + (item.product.prices.bigbasket * item.quantity), 0)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Delivery:</span>
